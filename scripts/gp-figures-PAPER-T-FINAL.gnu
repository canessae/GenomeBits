...
name_acgt = 'Thymine (T) Nucleobase'

name_output = 'Fig-T.png' 
...
name_11 = '1-input-PLOTS/00-FIGURES-PAPER/multiALL-T-sum01-complete.txt'
name_12 = '2-input-PLOTS/00-FIGURES-PAPER/multiALL-T-sum01-complete.txt'
name_13 = '3-input-PLOTS/00-FIGURES-PAPER/multiALL-T-sum01-complete.txt'

name_21 = '4-input-PLOTS/00-FIGURES-PAPER/multiALL-T-sum01-complete.txt'
name_22 = '5-input-PLOTS/00-FIGURES-PAPER/multiALL-T-sum01-complete.txt'
name_23 = '6-input-PLOTS/00-FIGURES-PAPER/multiALL-T-sum01-complete.txt'
...
mpl_dx     = 0.05 	# 0.1 inch  inter-plot vertical spacing
